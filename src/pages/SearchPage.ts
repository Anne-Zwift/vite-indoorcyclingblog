  ...
  const handleSearch = async (query: string) => {
    ...
    if (exactProfileMatch) {
      ...
      if (otherProfiles.length > 0) {
        ...
        otherProfilesHeading.className =
          'text-xl font-h1 font-bold mt-8 mb-4 text-p-text dark:text-slate-100 self-start';
      ...
      if (posts.length > 0) {
        ...
        postsHeading.className =
          'text-xl font-h1 font-bold mt-8 mb-4 text-p-text self-start dark:text-slate-100';
